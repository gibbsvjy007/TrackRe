...
/////////////////////
(function() {
    app.service('$itinerary', ['$q', '$log', '$http', '$service', '$gmap', function($q, $log, $http, $service, $gmap) {
        var service = {};
        service.itineraries = [];
        ...
        service.setItineraryFromTo = function(item){
            var obj = {
                from: item.from.name,
                to: item.to.name
            };
        ...
        service.getItineraryFromTo = function(item){            
            return service.fromTo;
        };
        return service;
    }]);
})();
